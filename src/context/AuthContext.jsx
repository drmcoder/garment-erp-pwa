...
export const AuthProvider = ({ children }) => {
  ...
  const mockUsers = [
    {
      ...
      stats: {
        ...
        todayEarnings: 237.5,
        weeklyPieces: 520,
        weeklyEarnings: 1456.0,
        monthlyPieces: 2480,
        monthlyEarnings: 6205.0,
      },
      currentWork: {
        bundleId: "bundle_001",
        articleNumber: "8085",
    ...
    },
    {
      ...
      stats: {
        ...
        todayEarnings: 201.6,
        weeklyPieces: 456,
        weeklyEarnings: 1276.8,
        monthlyPieces: 2016,
        monthlyEarnings: 5644.8,
      },
      currentWork: null,
    },
    {
      ...
      stats: {
        ...
        todayEarnings: 285.0,
        weeklyPieces: 612,
        weeklyEarnings: 1836.0,
        monthlyPieces: 2856,
        monthlyEarnings: 7140.0,
      },
      currentWork: {
        bundleId: "bundle_003",
        articleNumber: "6635",
    ...
    },
    {
      ...
      stats: {
        ...
        todayEarnings: 162.4,
        weeklyPieces: 378,
        weeklyEarnings: 1058.4,
        monthlyPieces: 1680,
        monthlyEarnings: 4704.0,
      },
      currentWork: null,
    },
    {
      ...
      stats: {
        ...
        todayEarnings: 180.0,
        weeklyPieces: 315,
        weeklyEarnings: 1260.0,
        monthlyPieces: 1350,
        monthlyEarnings: 5400.0,
      },
      currentWork: {
        bundleId: "bundle_005",
        articleNumber: "2233",
  ...
  const updateProfile = async (updates) => {
    ...
    try {
      ...
      // Update storage
      const storage = localStorage.getItem("garmentErpUser")
        ? localStorage
        : sessionStorage;
  ...
  const changePassword = async (currentPassword, newPassword) => {
    ...
    try {
      ...
      if (currentPassword !== "password123") {
        throw new Error(
          isNepali ? "हालको पासवर्ड गलत छ" : "Current password is incorrect"
        );
      }
  ...
  // Get user display info (for LogoutButton compatibility)
  ...
  const getOperatorsBySpeciality = (speciality) => {
    return mockUsers.filter(
      (user) => user.role === "operator" && user.speciality === speciality
    );
  };
