...
export const languages = {
  np: {
    ...
    efficiencyTrend: "दक्षता ट्रेन्ड र पूर्वानुमान",
    actualEfficiencyLabel: "वास्तविक दक्षता",
    aiPrediction: "AI पूर्वानुमान",
    mainBottlenecks: "मुख्य बाटलनेकहरू",
    highImpact: "उच्च",
    mediumImpact: "मध्यम",
    lowImpact: "कम",
    ...
    cause: "कारण",
    resolved: "समाधान भयो",
    aiRecommendations: "AI सिफारिसहरू",
    highPriority: "उच्च",
  ...
  en: {
    ...
    efficiencyTrend: "Efficiency Trend & Predictions",
    actualEfficiencyLabel: "Actual Efficiency",
